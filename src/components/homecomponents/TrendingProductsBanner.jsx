...
import img1 from "../../assets/home/workout.jpg";
import img2 from "../../assets/home/mencasual.jpg";
import img3 from "../../assets/home/multimaxi.jpg";
import img4 from "../../assets/home/smart.jpg";
import main from "../../assets/home/main.jpg";

export default function TrendingProductsBanner() {
  const products = [
    { name: "Plus-Size Womens Workout Set", image: img1 },
    { name: "Plus-Size Mens Smart Casual Wear", image: img2 },
    { name: "Multi Color Plus Size Maxi Dress", image: img3 },
    { name: "Plus-Size Mens Casual Wear", image: img4 },
  ];
    ...
    <section className="py-12 md:py-20">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          {/* RIGHT SIDE - Big Image (Centered Vertically) */}
